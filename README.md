...
based in china. mass side project hoarder. i build stuff because it sounds fun,
not because i have a plan. bots, automation scripts, monitoring tools, roblox macros,
discord things, streaming platforms — if it seems interesting i'm already halfway through it
before i realize i have 4 other unfinished projects.

i like making things that run by themselves so i can go do something else.
